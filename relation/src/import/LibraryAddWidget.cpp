...
nsRelation::LibraryAddWidget::LibraryAddWidget(QWidget* parent)
: QWidget(parent)
...
void nsRelation::LibraryAddWidget::libraryPathChanged(const QModelIndex& index) {
...
void nsRelation::LibraryAddWidget::addLibrary() {
...
void nsRelation::LibraryAddWidget::dividePathAt(int pos) {
